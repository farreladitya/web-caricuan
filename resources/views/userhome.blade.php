        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li><div class="gradient-button"><a id="modal_trigger" href="/home"><i class="fa fa-sign-in-alt"></i> Hi, Farrel!</a></div></li>
            </ul>
              ...
              <div class="left-content show-up header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                <div class="row">
                  <div class="col-lg-12">
                    ...
                    <p style="font-size: 16px">Start your journey with Cari.Cuan with attempting <br> Plan My Future Test. Know your special ability and get <br> your result as soon as possible </p>
                  </div>
                  <div class="col-3"></div>
                  <div class="col-4">
