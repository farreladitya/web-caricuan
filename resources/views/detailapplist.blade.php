...
<div class="main-banner wow fadeIn" id="top" data-wow-duration="1s" data-wow-delay="0.5s">
              ...
              <div class="left-content show-up header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                <div class="row">
                  <div class="col-lg-12" style="margin-left: -100px">
                    <p style="font-size: 35px; font-family: 'Poppins', sans-serif; margin-top: 90px; color: #ffff"> Applicant List</p>
                </div>
                </div>
  ...
  <div class="grey-box">
    ...
    <button href="/applist" class="button viewapp-btn viewapp-text">View Applicant</button>
</div>
